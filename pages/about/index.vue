        ...
        <nav class="hidden lg:flex flex-col gap-4 mt-12 text-sm font-display">
          ...
          >
            <span
              ...
              :class="activeId === 'intro' ? 'w-12 bg-white' : 'w-8 bg-white/20 group-hover:w-12'"
            ></span>
            Introduction
          </a>
          <a
          ...
          >
            <span
              class="h-px transition-all duration-300"
              :class="activeId === 'journey' ? 'w-12 bg-white' : 'w-8 bg-white/20 group-hover:w-12'"
            ></span>
            Journey
          </a>
          <a
          ...
          >
            <span
              class="h-px transition-all duration-300"
              :class="activeId === 'skill' ? 'w-12 bg-white' : 'w-8 bg-white/20 group-hover:w-12'"
            ></span>
            Skill
          </a>
        </nav>
