...
<template>
  <div class="">
    <div
      id="intro-1"
      class="flex flex-col h-screen w-full items-center justify-center panel bg-yellow-400"
    >
    ...
    <div
      id="intro-2"
      class="flex flex-col h-screen w-full items-center justify-center panel"
    >
