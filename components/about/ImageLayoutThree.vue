...
const images = [
  {
    ...
    alt: "Card Back",
    class: "w-48 h-52 rounded-md absolute top-16 left-0 z-10",
  },
  {
    src: "https://picsum.photos/200?2",
    alt: "Card Middle",
    class: "w-48 h-52 rounded-md absolute top-8 left-16 z-20 ",
  },
  {
    src: "https://picsum.photos/200?3",
    alt: "Card Front",
    class: "w-48 h-52 rounded-md absolute top-0 left-32 z-30 ",
  },
];
