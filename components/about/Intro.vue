      ...
      >
        ...
        <div class="space-y-6">
          ...
          <h1 class="text-reveal font-display uppercase group cursor-pointer">
            <span class="text-gradient-base"
              >Shafwan<br />Ilham<br />Dzaky</span
            >
          ...
          <div class="space-y-2 pl-1">
            <p class="font-decoration text-white/30">開発者</p>
            <p
            ...
            <div class="flex items-center gap-2 pt-2">
              ...
              ></span>
              <span
                class="text-xs text-green-400 uppercase tracking-wider font-display"
        ...
        <section class="w-full flex flex-col gap-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <NuxtLink
              to="/about/skill"
              class="group bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/30 transition-all duration-300"
            >
              <div class="flex justify-between items-start mb-3">
                ...
                <svg
                  class="w-5 h-5 text-white/40 group-hover:text-white group-hover:translate-x-1 transition-all"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p class="text-sm text-white/40 font-display">
                Full-stack, DevOps, and security credentials.
              </p>
            </NuxtLink>
            ...
            >
              <div class="flex justify-between items-start mb-3">
                ...
                <svg
                  class="w-5 h-5 text-white/40 group-hover:text-white transition-all"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p class="text-sm text-white/40 font-display">
                Complete work history and technical skills.
              </p>
            </NuxtLink>
          </div>
        </section>
